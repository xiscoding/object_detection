...
'''
TODO:
1. Modify code so variables that can't be accessed are available


2. Modify code to display images. Use cv2:
    Image.fromarray(image_with_boxes)
    Image.fromarray(image_with_masks)

3. Reorginize code to be easier to read and understand. 
'''
